<?php
// source: C:\xampp\htdocs\Nette_seminarka\app/config/config.neon 

class Container_2643103d0f extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Nette\Security\IAuthenticator' => [1 => ['24_App_Authenticator_BasicAuthenticator']],
			'App\Authenticator\BasicAuthenticator' => [1 => ['24_App_Authenticator_BasicAuthenticator']],
			'App\Model\GoodsManager' => [1 => ['25_App_Model_GoodsManager']],
			...
			'App\Presenters\ItemPresenter' => [1 => ['application.4']],
		...
		'services' => [
			'24_App_Authenticator_BasicAuthenticator' => 'App\Authenticator\BasicAuthenticator',
			'25_App_Model_GoodsManager' => 'App\Model\GoodsManager',
			...
			'application.4' => 'App\Presenters\ItemPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\Nette_seminarka\app',
			'wwwDir' => 'C:\xampp\htdocs\Nette_seminarka\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\Nette_seminarka\app/../temp',
		];
	}


	/**
	 * @return App\Authenticator\BasicAuthenticator
	 */
	public function createService__24_App_Authenticator_BasicAuthenticator()
	{
		$service = new App\Authenticator\BasicAuthenticator($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return App\Model\GoodsManager
	 */
	public function createService__25_App_Model_GoodsManager()
	{
		$service = new App\Model\GoodsManager($this->getService('database.default.context'));
		return $service;
	}
	...
	public function createService__26_App_Model_UserManager()
	{
		$service = new App\Model\UserManager(
			...
			$this->getService('24_App_Authenticator_BasicAuthenticator')
		);
		return $service;
	}
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('25_App_Model_GoodsManager'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	/**
	 * @return App\Presenters\ItemPresenter
	 */
	public function createServiceApplication__4()
	{
		$service = new App\Presenters\ItemPresenter($this->getService('25_App_Model_GoodsManager'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__presenterFactory()
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\Nette_seminarka\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\Nette_seminarka\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\Nette_seminarka\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=cenik', 'root', null, null);
	...
	{
		return new Container_2643103d0f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_2643103d0f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_2643103d0f $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\Nette_seminarka\app/../temp/cache/latte');
